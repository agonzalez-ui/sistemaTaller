    ...
    <div class="mt-6">
        <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-wrap gap-3 border-t border-slate-200 pt-5">
                <button type="submit" class="inline-flex min-h-12 items-center justify-center rounded-xl bg-amber-400 px-5 py-3 font-semibold text-slate-950 hover:bg-amber-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2">Actualizar rol</button>
